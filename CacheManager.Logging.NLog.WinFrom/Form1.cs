...
namespace CacheManager.Logging.NLog.WinFrom
{
    public partial class Form1 : Form
    {
        ...
        private string ListenerIP = ConfigurationSettings.AppSettings["ListenerIP"].ToString();
        private int ListenerPort =Convert.ToInt32(ConfigurationSettings.AppSettings["ListenerPort"].ToString());
